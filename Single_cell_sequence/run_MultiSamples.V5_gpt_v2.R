#!/usr/bin/env Rscript
#==============================================================================
# 脚本名: run_MultiSamples.V5_gpt_v2.R
# 功能:  单细胞的第一步脚本，处理cellranger的结果文件，可以做分组。结果最好还是人工审核一下
# 作者:  adolf1
# 邮箱:  wangjyafk@126.com
# 创建:  2025-06-01
# 更新:  2025-12-15 adolf1
# 依赖:  R≥4.0 data.table ggplot2
# 用法:  Rscript run_MultiSamples.V5_gpt_v2.R --参数
...
if (cell_number > 500000) pt_use <- 0.05
if (cell_number > 800000) pt_use <- 0.03
